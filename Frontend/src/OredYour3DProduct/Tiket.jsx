...
//         let res = await axios.get(`http://localhost:4000/api/yourtiketof3d/${_id}`)
...
//             <div className='qrname mb-2'>{data.clientName} </div>
//             <div id='pdf6' className="conForm1">  <QrCode fgColor='#193566' value={domainNow + '/checkyouorder/' + _id} height={50} size={90} /></div>
//             <div className='ticketnumber'> {data._id} </div>
//             <div>Your submission has been sent</div>
//             <hr style={{ width: "100%" }} />
//             <div className='qrlocation'> <FaWhatsapp className='mr-2' />{data.clientPhone}</div>
//             <hr style={{ width: "100%" }} />
//             {data.clientEmail === "" ? "" : <div className='qrlocation'><HiOutlineMail className='mr-2' />{data.clientEmail}</div>}
...
//                         <div className='thankmsg' style={{width: "100%", textAlign: "center"}}>We will reach out to you soon</div>
//                         <div className="conForm" id="pdf4" >

//                             <h4>Thank You</h4>
                          
//                             <Link style={{ display: 'flex', alignItems: "center", border: "2px solid #ecf0f3" }} className="downloadInvoice" to="/order3d" >
//                                 <div>Go back Service page</div>
//                             </Link>
//                             <br />
